...
export const SITE_INFO = {
  name: "Sarvagun Gyannodaya Trust",
  shortName: "Sarvagun",
  tagline: "Education, dignity, and care — for every life.",
  description: "Empowering Lives Through Education, Care & Community Development",
  founder: {
    name: "Mr. Rahul Rawat",
  ...
  contact: {
    ...
    email: "info@sarvagungyannodayatrust.org",
    emailResponseTime: "We reply within 24-48 hours",
    address: {
      street: "[Full Trust Address]",
      cityState: "[City, State - PIN Code]",
      country: "India"
    }
  },
  legal: {
    act: "Registered under Indian Trust Act, 1882",
    regNo: "Reg. No: [XXXXXX]",
    taxExemption: "80G / 12A — Donations tax-exempt"
  }
};
